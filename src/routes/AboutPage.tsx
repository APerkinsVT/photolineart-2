        ...
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <div className="faq-list" style={{ gap: '1rem' }}>
            <div className="faq-item" style={{ borderColor: 'var(--color-border)' }}>
              ...
              <p className="faq-answer" style={{ color: 'var(--color-text-primary)', fontSize: '1rem', lineHeight: 1.8 }}>
                The prototype started as a single coloring page with a few tips. Then it grew into a way to create a 6-photo coloring book of meaningful moments—something you could print, bind at an office supply store, and give as a real, keepsake gift.
              </p>
              <p className="faq-answer" style={{ color: 'var(--color-text-primary)', fontSize: '1rem', lineHeight: 1.8 }}>
